...
class Dark_Music_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'dark_music';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'dark-music' ), $i ),
...
// Initialize.
$dark_music_footer_widgets = new Dark_Music_Footer_Widgets();
