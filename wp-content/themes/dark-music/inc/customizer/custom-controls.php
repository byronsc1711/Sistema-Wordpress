 ...
 */
class Dark_Music_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    <label>
      ...
      <?php endif; ?>
       <select <?php $this->link(); ?>>
			<?php
			printf( '<option value="%s" %s>%s</option>', '', selected( $this->value(), '', false ), esc_html__('--None--', 'dark-music') );
			?>
 ...
 * @see WP_Customize_Control
 */
class Dark_Music_Dropdown_Category_Control extends WP_Customize_Control {
...
class Dark_Music_Note_Control extends WP_Customize_Control {
...
class Dark_Music_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Dark_Music_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="dark-music-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class Dark_Music_Multiple_Dropdown_Chooser extends WP_Customize_Control{
	public $type = 'dropdown_chooser';
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="dark-music-chosen-select" <?php $this->link(); ?> multiple>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class Dark_Music_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Dark_Music_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="dark-music-sortable-list">
      ...
      ?>
        ...
        <li>
            <input class="dark-music-sortable-input sortable-hideme" name="<?php echo esc_attr( $trimmed_value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
            <span class ="menu-item-handle sortable-span"> <?php echo esc_html( $value ); ?> </span>
          <i class="dashicons dashicons-menu dark-music-drag-handle"></i>
        </li>
        ...
        <li class="sortable-hideme">
          <input class="dark-music-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Dark_Music_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Dark_Music_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Dark_Music_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
...
if ( ! function_exists( 'dark_music_recent_product_options' ) ) :
    /**
     * List of recent_product options
     * @return array List of recent_product options.
     */
    function dark_music_recent_product_options() {
    
        if ( class_exists( 'WooCommerce' ) ) {
                $arr = array(
                'product'           => esc_html__( 'Product', 'dark-music' ),
                'product_cat'       => esc_html__( 'Product Category', 'dark-music' ),
                'recent_product'    => esc_html__( 'Recent Product', 'dark-music' ),
            );
        }

        return apply_filters( 'dark_music_recent_product_options', $arr );
    }
endif;