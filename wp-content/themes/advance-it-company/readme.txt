=== Advance IT Company WordPress Theme ===
...
= 0.4.2 =
* Added border radius and Padding button option for home page and blog page in customizer.
...
= 0.5.9 =
* Changed search code.
* Added js for sticky header of responsive media.
...
Advance IT Company is distributed under the terms of the GNU GPL

Advance IT Company WordPress Theme is derived from Twenty Sixteen WordPress Theme, Copyright 2014-2015 WordPress.org
...
6. Screenshot Images.
	...
	Slider image, Copyright Rawpixel.com
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/T6VK7MUY6A

	Service Post image, Copyright Rawpixel.com
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/NSJ7MFQ6SF
