...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'consultare-light' ); ?></a>

	<?php 
	get_template_part( 'template-parts/header/' . consultare_gtm( 'consultare_header_style' ) );
