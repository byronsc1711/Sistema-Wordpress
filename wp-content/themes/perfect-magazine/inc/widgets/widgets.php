    ...
    class Perfect_Magazine_Widget_Vertical_List extends Perfect_Magazine_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            $fields = array(
                ...
                'popup_dissable' => array(
                    'label' => __('Enable Image Pop-Up', 'perfect-magazine'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'post_category' => array(
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12" data-mh="list-height">
                                <article class="article-vertical-list">
                                        ...
                                        <div class="post-image">
                                            <a href="<?php the_permalink(); ?>" class="reveal-disable">
                                                <img src="<?php echo esc_url($url); ?>"
                                                     alt="<?php the_title_attribute(); ?>">
                                            </a>
                                        </div>
    ...
    class Perfect_Magazine_Widget_Grid_List extends Perfect_Magazine_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            $fields = array(
                ...
                'description_featured' => array(
                    'label' => __('Description for featured post Only:', 'perfect-magazine'),
                    'type' => 'number',
                    'default' => 0,
                    'css' => 'max-width:60px;',
                    'min' => 0,
                    ...
                    foreach ($all_posts as $key => $post) : ?>
                        ...
                        <?php if ($i == 1) { ?>
                            ...
                            <div class="row row-collapse row-table row-bg <?php echo esc_attr($image_class); ?>">
                                ...
                                <?php } else { ?>
                                    <div class="col-sm-6 article-feature-image ">
                                        <a href="<?php the_permalink(); ?>" class="reveal-disable">
                                            <img src="<?php echo esc_url($url1); ?>" alt="<?php the_title_attribute(); ?>">
                                        </a>
                                    </div>
                                ...
                                <div class="col-sm-6 article-feature-content">
                                    <div class="article-content">
                                        ...
                                        <?php if (absint($params['description_featured']) > 0) : ?>
                                            <div class="grid-description">
                                                <?php
                                                $excerpt = perfect_magazine_words_count(absint($params['description_featured']), get_the_content());
                            ...
                            <div class="col-sm-4" data-mh="grid-height">
                                <article class="article-vertical-list">
                                    ...
                                    <?php } else { ?>
                                        <div class="post-image">
                                            <a href="<?php echo esc_url($url_large); ?>" class="reveal-disable">
                                                <img src="<?php echo esc_url($url); ?>"
                                                     alt="<?php the_title_attribute(); ?>">
                                            </a>
                                        </div>
        ...
        function widget($args, $instance)
        {
            ...
            <div class="widget-wrapper widget-wrapper-slider">
                <div class="container">
                    ...
                    <div class="tm-slider-widget" data-slick='{"rtl": <?php echo($rtl_class); ?>}'>
                        <?php foreach ($all_posts as $key => $post) : ?>
                            <?php setup_postdata($post); ?>
                            <?php if (has_post_thumbnail()) {
                ...
                <div class="container">
                    ...
                    <div class="tm-carousel-widget">
                        <?php foreach ($all_posts as $key => $post) : ?>
                            ...
                            ?>
                            <div class="slick-item" data-slick='{"rtl": <?php echo($rtl_class); ?>}'>
        ...
        function __construct()
        {
            ...
            $fields = array(
                ...
                'enable_discription' => array(
                    'label' => __('Enable Description:', 'perfect-magazine'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                ...
                <ul class="recent-widget-list">
                    <?php foreach ($all_posts as $key => $post) : ?>
                        ...
                        <li class="full-item clearfix">
                            <div class="row">
                                <div class="full-item-image item-image col-xs-4">
                                    <?php if (has_post_thumbnail()) {
                                        $thumb = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'perfect-magazine-460-280');
                                        $url = $thumb['0'];
                                    } else {
...
if (!class_exists('Perfect_Magazine_Tabbed_Widget')) :
    ...
    class Perfect_Magazine_Tabbed_Widget extends Perfect_Magazine_Widget_Base
    {
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="tab tab-popular active">
                            <a href="#<?php echo esc_attr($tab_id); ?>-popular"
                               aria-controls="<?php esc_attr_e('Popular', 'perfect-magazine'); ?>" role="tab"
                        ...
                        <li class="tab tab-recent">
                            <a href="#<?php echo esc_attr($tab_id); ?>-recent"
                               aria-controls="<?php esc_attr_e('Recent', 'perfect-magazine'); ?>" role="tab"
                               data-toggle="tab" class="tab-popular-bgcolor">
                        ...
                        <li class="tab tab-comments">
                            <a href="#<?php echo esc_attr($tab_id); ?>-comments"
                               aria-controls="<?php esc_attr_e('Comments', 'perfect-magazine'); ?>" role="tab"
                               data-toggle="tab" class="tab-popular-bgcolor">
                            ...
                            <div class="full-item-image item-image col-xs-4">
                                <a href="<?php the_permalink(); ?>" class="news-item-thumb">
                                    <?php if (has_post_thumbnail($post->ID)) : ?>
                                        ...
                                        <?php endif; ?>
                                    <?php else : ?>
                                        <img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/images/no-image-720x480.jpg'; ?>" alt="<?php the_title_attribute(); ?>"/>
                                    <?php endif; ?>
                                </a>
                            </div>
                            <div class="col-xs-8">
        ...
        function render_comments($params)
        {
            ...
            <ul class="article-item article-list-item comments-tabbed--list">
    ...
    class Perfect_Magazine_Author_Post_widget extends Perfect_Magazine_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            $fields = array(
                ...
                'url-insta' => array(
                    'label' => __('Instagram URL:', 'perfect-magazine'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
            );
