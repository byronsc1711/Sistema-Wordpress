...
if ( ! class_exists( 'Shark_Business_Featured_Widget' ) ) :

     
    class Shark_Business_Featured_Widget extends WP_Widget {
        /**
        ...
        public function __construct() {
            $st_widget_featured = array(
                ...
                'description' => esc_html__( 'Compatible Area: Homepage, Sidebar, Footer', 'shark-business' ),
            );
            parent::__construct( 'shark_business_featured_widget', esc_html__( 'ST: Featured Widget', 'shark-business' ), $st_widget_featured );
        }
                                        ...
                                        <div class="post-wrapper">
                                            ...
                                            <div class="entry-container">
                                                ...
                                                <div class="entry-content">
                                                    <?php echo esc_html( shark_business_trim_content( 20 ) ); ?>
                                                </div><!-- .entry-content -->
                                                <div class="read-more">
        ...
        public function form( $instance ) {
            $title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Featured', 'shark-business' );
            $read_more  = isset( $instance['read_more'] ) ? $instance['read_more'] : esc_html__( 'Read More', 'shark-business' );
