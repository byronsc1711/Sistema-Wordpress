...
function bosa_corporate_business_default_styles(){

	// Begin Style
	$css = '<style>';

	$header_image_height = get_theme_mod( 'header_image_height', 100 );
	$css .= '
...
add_action( 'wp_head', 'bosa_corporate_business_default_styles', 99 );