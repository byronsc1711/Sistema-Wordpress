...
if ( ! function_exists( 'bosa_corporate_business_enqueue_styles' ) ) :
	/**
	 * @since Bosa Corporate Business 1.0.0
	 */
	function bosa_corporate_business_enqueue_styles() {
		wp_enqueue_style( 'bosa-corporate-business-style-parent', get_template_directory_uri() . '/style.css',
			array(
				'bootstrap',
				'slick',
				'slicknav',
...
add_action( 'wp_enqueue_scripts', 'bosa_corporate_business_enqueue_styles', 1 );


if ( ! function_exists( 'bosa_corporate_business_modify_locale' ) ) :
	/**
	 ...
	 * @return array
	 */
	function bosa_corporate_business_modify_locale( $locale ) {
	...
	add_filter( 'bosa_localize_var', 'bosa_corporate_business_modify_locale' );
endif;
...
if( !function_exists( 'bosa_transparent_body_class' ) ){
	...
	*
	* @since Bosa Corporate Business 1.0.1
	* @param array $class
	* @return array $class
	*/
