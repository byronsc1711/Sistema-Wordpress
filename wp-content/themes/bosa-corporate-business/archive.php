						...
						<?php
							if( !get_theme_mod( 'disable_pagination', false ) ):
								the_posts_pagination( array(
									'next_text' => '<span>'.esc_html__( 'Next', 'bosa-corporate-business' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-corporate-business' ) . '</span>',
									'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-corporate-business' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-corporate-business' ) . '</span>',
									'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-corporate-business' ) . ' </span>',
								));
							endif;
						?>
					</div><!-- #primary -->
