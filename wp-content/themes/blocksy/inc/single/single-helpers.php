	...
	<div class="<?php echo esc_attr($class); ?>">
		...
		<?php if ( $medium ) { ?>
			<a href="<?php echo esc_url( $medium ); ?>" target="_blank" rel="noopener noreferrer">
				<svg class="ct-icon" width="12" height="12" viewBox="0 0 20 20"><path d="M2.4 5.3c0-.2-.1-.5-.3-.7L.3 2.4v-.3H6l4.5 9.8 3.9-9.8H20v.3l-1.6 1.5c-.1.1-.2.3-.2.4v11.2c0 .2 0 .3.2.4l1.6 1.5v.3h-7.8v-.3l1.6-1.6c.2-.2.2-.2.2-.4V6.5L9.4 17.9h-.6L3.6 6.5v7.6c0 .3.1.6.3.9L6 17.6v.3H0v-.3L2.1 15c.2-.2.3-.6.3-.9V5.3z"/></svg>
			</a>
		<?php } ?>
		...
		<?php if ( $tiktok ) { ?>
			<a href="<?php echo esc_url( $tiktok ); ?>" target="_blank" rel="noopener noreferrer">
				<svg class="ct-icon" width="12" height="12" viewBox="0 0 20 20"><path d="M18.2 4.5c-2.3-.2-4.1-1.9-4.4-4.2V0h-3.4v13.8c0 1.4-1.2 2.6-2.8 2.6-1.4 0-2.6-1.1-2.6-2.6s1.1-2.6 2.6-2.6h.2l.5.1V7.5h-.7c-3.4 0-6.2 2.8-6.2 6.2S4.2 20 7.7 20s6.2-2.8 6.2-6.2v-7c1.1 1.1 2.4 1.6 3.9 1.6h.8V4.6l-.4-.1z"/></svg>
			</a>
		<?php } ?>
	</div>
	...
	<div class="<?php echo esc_attr($class); ?>" data-type="<?php echo esc_attr($type); ?>">
		<?php
			echo blocksy_simple_image(
				get_avatar_url(blocksy_get_author_id(), ['size' => 120]),
				[
					'tag_name' => 'a',
					'inner_content' => '
