...
= 1.2.2 =
* Dark skin style issue fixed.

= 1.2.1 =
* Style issue fixed.

= 1.2.0 =
* Child theme compatibility issue fixed.

= 1.1.9 =
* Font awesome icons and elementor issue fixed.

= 1.1.8 =
* Style issue fixed.
* Category selection option added to Latest Posts section.
...
* Image for theme screenshot, Copyright Q000024
  ...
  Logo, Copyright 2021 Keon Themes
  License: GNU General Public License v3 http://www.gnu.org/licenses/gpl-3.0.html

  Illustrations and icons used in Screenshot, Copyright 2021 Keon Themes
  License: GNU General Public License v3 http://www.gnu.org/licenses/gpl-3.0.html
