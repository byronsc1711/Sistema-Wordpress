...
<div class="wedevs-post-wrapper">
            ...
            <div class="site-row">
                <div class="site-column site-column-3 site-column-sm-12">
                    <?php if ('post' === get_post_type()) : ?>
                        ...
                        <div class="entry-meta">
                            <?php anecdote_lite_posted_by($c_title = true, $image = true); ?>
                        </div>
                        <div class="entry-meta">
                        ...
                        <?php if (!is_singular()) : ?>
                            <div class="wedevs-continue-reading">
                                <a href="<?php the_permalink(); ?>" class="wedevs-btn wedevs-btn-primary">
                                    <?php esc_html_e('Continue Reading', 'anecdote-lite'); ?>
                            ...
                            if (!is_single() && !post_password_required() && (comments_open() || get_comments_number())) {
                                ...
                                <div class="comment-link">
                                    <a href="<?php echo esc_url($comment_url); ?>">
                                        <span><?php anecdote_lite_get_theme_svg('comment'); ?></span>
                                        <span><?php echo absint($comment_count) . esc_html__(' Comments', 'anecdote-lite'); ?></span>
                                    </a>
                                </div>
    ...
    <?php if (!is_search()) {
        anecdote_lite_archive_recommended_posts();
    } ?>
