 ...
 * @since 1.0.0
 */
class Anecdote_Lite_Widget_Base extends WP_Widget {
        ...
        switch ( $field_type ) {
                        ...
                        <div class="wedevs-img-fields-wrap">
                            <div class="wedevs-attachment-media-view">
                                ...
                                <div class="wedevs-attachment-child wedevs-uploader">
                                    ...
                                    <input type="hidden" class="upload-id" name="<?php echo esc_attr( $this->get_field_name( $key ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>" value="<?php echo esc_attr( $value ); ?>" />

                                </div>

                                <div class="wedevs-attachment-child wedevs-thumbnail-image">

                                    <button type="button" class="wedevs-img-delete-button <?php if( $value ) { echo 'wedevs-img-show'; } ?>">
                                    ...
                                    <div class="wedevs-img-container">
                                        ...
                                        <?php if( $value ){
                                            ...
                                            <img src="<?php echo esc_url( $image ); ?>" style="width:200px;height:auto;">
            ...
            case 'select':
                ...
                <p>
                    ...
                    id="<?php echo esc_attr( $this->get_field_id( $key ) ); ?>"
                    name="<?php echo esc_attr( $this->get_field_name( $key ) ); ?>"
                    class="<?php echo esc_attr( $field['class'] ); ?> widefat"
                    style="<?php echo esc_attr( $field['css'] ); ?>"
                    >
                    <?php if ( ! empty( $field['options'] ) ) : ?>
