(function ($) {
  ...
  var ajaxurl = anecdote_lite_admin.ajax_url;
  var ajaxNonce = anecdote_lite_admin.ajax_nonce;

  $('.wedevs-dismiss-notice').click(function(){
    
    var currentElement = $(this);
    var data = {
          'action': 'anecdote_lite_about_notice_dismiss',
          '_wpnonce': ajaxNonce,
      };
  ...
  // Image Upload
    ...
    frame = wp.media({
        title: anecdote_lite_admin.title,
        button: {
        text: anecdote_lite_admin.label
        },
  ...
  $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        var data = {
            ...
            'action': 'anecdote_lite_install_plugins',
            '_wpnonce': ajaxNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {
            
            var active = anecdote_lite_admin.active
            var deactivate = anecdote_lite_admin.deactivate
