...
<main id="site-main">
	...
	<div class="site-page-content">
		<div class="site-section-wrapper site-section-wrapper-main clearfix">
			...
			<h1 class="page-title"><?php esc_html_e( 'Page not found', 'podcast' ); ?></h1>

			<div class="archives-content clearfix"><p><?php esc_html_e( 'Apologies, but the requested page cannot be found. Perhaps searching will help find a related page.', 'podcast' ); ?></p></div>
			<hr />
			<?php 
			get_search_form();
			?>
			...
			<div class="entry-content clearfix">
				...
				<h3><?php esc_html_e( 'Browse Categories', 'podcast' ); ?></h3>
				<ul>
				...
				<h3><?php esc_html_e( 'Monthly Archives', 'podcast' ); ?></h3>
				<ul>
